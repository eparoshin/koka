...
kk_decl_export size_t kk_ws_queue_steal(kk_ws_queue_t* from, kk_ws_queue_t* to, size_t maxst, uintptr_t* out_task);
kk_decl_export size_t kk_ws_queue_grab(kk_ws_queue_t* q, size_t maxst, uintptr_t* out);
